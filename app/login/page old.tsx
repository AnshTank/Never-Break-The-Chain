      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-6 shadow-sm">
          <div className="text-center mb-6">
            <h1 className="text-2xl font-semibold bg-gradient-to-r from-slate-900 to-slate-600 bg-clip-text text-transparent tracking-tight mb-2 transition-all duration-300 hover:from-amber-800 hover:to-orange-700">
              🔗 NEVER BREAK THE CHAIN
            </h1>
            <p className="text-slate-600 dark:text-slate-400 text-sm">Welcome back to your journey</p>
          </div>
